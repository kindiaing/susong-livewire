...
class SkuList extends Component
{
    ...
    public function save(): void
    {
        $validated = $this->validate([
            ...
            'formPurchasePrice' => 'nullable|numeric|min:0',
            'formWholesalePrice' => 'nullable|numeric|min:0',
            'formCostPrice' => 'nullable|numeric|min:0',
        ...
        $data = [
            ...
            'specs' => $specs,
            'purchase_price' => money_to_cents($validated['formPurchasePrice'] ?: 0),
            'wholesale_price' => money_to_cents($validated['formWholesalePrice'] ?: 0),
            'cost_price' => money_to_cents($validated['formCostPrice'] ?: 0),
        ...
        if ($this->editingId) {
            ...
            if ($oldWholesaleCents > 0 && $newWholesaleCents !== $oldWholesaleCents) {
                ...
                $pricingService->logPriceChange(
                    ...
                    targetType: PriceChangeLog::TARGET_SKU,
                    targetId: $sku->id,
                );
            }
