<div class="p-6">
    ...
    <div class="rounded-lg border bg-card">
        <div class="grid grid-cols-[60px_1fr_1fr_80px_100px] gap-3 border-b px-6 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wider">
            <div>ID</div><div>模板名称</div><div>商家</div><div>状态</div><div>操作</div>
        </div>
        @forelse($templates as $tpl)
            <div class="grid grid-cols-[60px_1fr_1fr_80px_100px] gap-3 border-b last:border-b-0 px-6 py-3 items-center hover:bg-muted/30 transition-colors" wire:key="rt-{{ $tpl->id }}">
