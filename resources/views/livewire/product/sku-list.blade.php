<div class="p-6">
    ...
    <div class="rounded-lg border bg-card">
        <div class="grid grid-cols-[60px_120px_1fr_120px_120px_120px_80px_80px_80px_100px] gap-2 border-b px-6 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wider">
            <div>ID</div>
            <div>SKU编码</div>
            <div>商品名称</div>
            <div>采购价</div>
        ...
        @forelse($skus as $sku)
            <div class="grid grid-cols-[60px_120px_1fr_120px_120px_120px_80px_80px_80px_100px] gap-2 border-b last:border-b-0 px-6 py-3 items-center hover:bg-muted/30 transition-colors" wire:key="sku-{{ $sku->id }}">
                ...
                <div class="text-sm text-foreground">{{ $sku->purchase_price }}</div>
                <div class="text-sm text-foreground">{{ $sku->wholesale_price }}</div>
                <div class="text-sm text-foreground">{{ $sku->cost_price }}</div>
