<div class="p-6">
    ...
    <div class="rounded-lg border bg-card">
        ...
        @forelse($keywords as $kw)
            <div class="grid grid-cols-[60px_1fr_1fr_100px_100px] gap-3 border-b last:border-b-0 px-6 py-3 items-center hover:bg-muted/30 transition-colors" wire:key="keyword-{{ $kw->id }}">
