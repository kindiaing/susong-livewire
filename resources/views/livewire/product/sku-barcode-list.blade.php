<div class="p-6">
    ...
    <div class="rounded-lg border bg-card">
        <div class="grid grid-cols-[60px_120px_1fr_100px_100px_80px_80px_80px_100px] gap-2 border-b px-6 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wider">
            <div>ID</div>
            <div>SKU编码</div>
            <div>条码值</div>
            <div>条码类型</div>
        ...
        @forelse($barcodes as $barcode)
            <div class="grid grid-cols-[60px_120px_1fr_100px_100px_80px_80px_80px_100px] gap-2 border-b last:border-b-0 px-6 py-3 items-center hover:bg-muted/30 transition-colors" wire:key="barcode-{{ $barcode->id }}">
