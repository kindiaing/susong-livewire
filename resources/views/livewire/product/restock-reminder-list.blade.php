<div class="p-6">
    ...
    <div class="rounded-lg border bg-card overflow-x-auto">
        <div class="grid grid-cols-[60px_1fr_1fr_100px_100px_120px_80px_100px] gap-3 border-b px-6 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wider min-w-[800px]">
            <div>ID</div>
            <div>商家</div>
            <div>SKU</div>
            <div>阈值</div>
        ...
        @forelse($items as $item)
            <div class="grid grid-cols-[60px_1fr_1fr_100px_100px_120px_80px_100px] gap-3 border-b last:border-b-0 px-6 py-3 items-center hover:bg-muted/30 transition-colors min-w-[800px]"
