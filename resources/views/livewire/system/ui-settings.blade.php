            ...
            <div class="fixed right-0 inset-y-0 bg-background border-l border-border shadow-xl"
                ...
                <div class="p-4 space-y-4">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center justify-between rounded-sm border border-border p-3">
                                ...
                                <label class="relative inline-flex cursor-pointer items-center">
                                    <input type="checkbox"
                                           wire:model.live="closeOnOutside"
                                           class="peer sr-only" />
                    ...
                    <button type="button" wire:click="save" wire:loading.attr="disabled"
                            class="inline-flex items-center justify-center rounded-sm bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90 transition-colors disabled:opacity-50">
