<div class="p-6">
    ...
    <div class="rounded-lg border bg-card">
        <div class="grid grid-cols-[60px_120px_1fr_80px_80px_100px] gap-3 border-b px-6 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wider">
            <div>ID</div>
            <div>车牌号</div>
            <div>车辆类型</div>
            <div>冷链</div>
        ...
        @forelse($vehicles as $vehicle)
            <div class="grid grid-cols-[60px_120px_1fr_80px_80px_100px] gap-3 border-b last:border-b-0 px-6 py-3 items-center hover:bg-muted/30 transition-colors"
