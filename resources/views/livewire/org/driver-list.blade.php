<div class="p-6">
    ...
    <div class="rounded-lg border bg-card">
        <div class="grid grid-cols-[60px_1fr_120px_160px_80px_80px_100px] gap-3 border-b px-6 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wider">
            <div>ID</div>
            <div>姓名</div>
            <div>手机号</div>
            <div>身份证</div>
        ...
        @forelse($drivers as $driver)
            <div class="grid grid-cols-[60px_1fr_120px_160px_80px_80px_100px] gap-3 border-b last:border-b-0 px-6 py-3 items-center hover:bg-muted/30 transition-colors"
