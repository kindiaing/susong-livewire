    ...
    <div class="flex items-center justify-between mb-6">
        <div class="flex items-center gap-3">
            <div>
                ...
                <p class="text-muted-foreground mt-1">拣货全流程：待分配→拣货中→已完成</p>
            </div>
            ...
            <div x-data="{ show: false, timer: null, top: 0, left: 0 }"
                ...
                <template x-teleport="body">
                    <div x-show="show"
                        ...
                        <div class="p-6">
                            <div class="text-sm font-semibold text-foreground mb-3">拣货任务状态流转</div>
                            <div class="flex items-center gap-1.5 flex-wrap">
                                <span class="inline-flex items-center rounded px-2.5 py-1 text-[11px] font-medium leading-none bg-yellow-100 text-yellow-700">1 待分配</span>
                                ...
                                <x-ui.icon name="chevron-right" class="w-3.5 h-3.5 text-muted-foreground shrink-0" />
                                <span class="inline-flex items-center rounded px-2.5 py-1 text-[11px] font-medium leading-none bg-green-100 text-green-700">3 已完成</span>
                            </div>
                        </div>
                    </div>
                </template>
            ...
            <div x-data="{ show: false, timer: null, top: 0, left: 0 }"
                ...
                <template x-teleport="body">
                    <div x-show="show"
                         ...
                         :style="'top:' + top + 'px;left:' + left + 'px'">
                        <div class="p-6">
                            <div class="text-sm font-semibold text-foreground mb-4">拣货任务流程说明</div>
                            <div class="space-y-3">
                                <div class="flex items-center gap-3">
                                    <span class="inline-flex items-center justify-center rounded px-2.5 py-1 w-[60px] text-[11px] font-medium leading-none bg-yellow-100 text-yellow-700 shrink-0">待分配</span>
                                    <span class="text-[11px] leading-snug text-muted-foreground">订单生成拣货任务，等待分配拣货员</span>
                                </div>
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="text-[11px] leading-snug text-muted-foreground">拣货员已接单，正在按单拣选商品</span>
                                </div>
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="text-[11px] leading-snug text-muted-foreground">所有商品拣选完毕，任务完成</span>
                                </div>
                            </div>
                        </div>
                    </div>
