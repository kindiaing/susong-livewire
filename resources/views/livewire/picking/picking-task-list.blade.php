<div class="p-6">
    ...
    <div class="rounded-lg border bg-card">
        ...
        @forelse($items as $item)
            <div class="grid grid-cols-[60px_1fr_120px_100px] gap-3 border-b last:border-b-0 px-6 py-3 items-center hover:bg-muted/30 transition-colors" wire:key="picking-task-list-{{ $item->id }}">
