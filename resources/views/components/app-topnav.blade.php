            ...
            <x-nav-menu class="hidden md:flex">
                ...
                @php
                    ...
                    $linkIconMap = [
                        ...
                        'delivery.route' => 'signal', 'delivery.task' => 'truck',
                        'delivery.delivery-note' => 'document',
                        ...
                        'inventory.picking-task' => 'clipboard-document-list',
                        ...
                        'org.driver' => 'user-circle', 'org.vehicle' => 'truck',
