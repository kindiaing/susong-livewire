...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('merchants', function (Blueprint $table) {
            ...
            $table->decimal('latitude', 10, 7)->nullable()->comment('纬度（GCJ-02坐标系）');
            $table->decimal('longitude', 10, 7)->nullable()->comment('经度（GCJ-02坐标系）');
            $table->string('coordinate_type', 10)->default('gcj02')->comment('坐标系类型：gcj02/wgs84/bd09');
            $table->string('geohash', 12)->nullable()->comment('Geohash编码（就近查询优化）');
